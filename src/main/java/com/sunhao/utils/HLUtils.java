...
/**
 * @ClassName: ESUtils
 * @Description: Elasticsearch一些操作 高亮显示
 * @author: 
 * @date: 2019年7月24日 上午10:14:13
 */
							...
							if (searchHits != null && searchHits.length > 0) {
								...
								for (int i = 0; i < searchHits.length; i++) {
									...
									for (int k = 0; k < fields.length; k++) {
										...
										if (!fieldName.equals("serialVersionUID")&&!fieldName.equals("user")&&!fieldName.equals("imgList")&&!fieldName.equals("articleType")&&!fieldName.equals("category")&&!fieldName.equals("channel")) {
