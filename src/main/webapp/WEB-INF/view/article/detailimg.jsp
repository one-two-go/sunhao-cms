...
<div id="myCarousel" class="carousel slide" style="minheight:200px">
    ...
    <ol class="carousel-indicators">
        <c:forEach items="${article.imgList}" var="img" varStatus="index">
    ...
    <div class="carousel-inner thumbnail" style="border-radius:12px;">
        <c:forEach items="${article.imgList}" var="img" varStatus="index">
            <div class="item ${index.index==0?"active":"" }">
                <img  class="img-rounded"  src="/pic/${img.url}" style=" border-radius:24px; align:center;width:800px; height:400px;" alt="First slide">
            </div>
        </c:forEach>
